@extends('uajtc.layout.MasterGuest')
@section('contain')
@include('uajtc.include.nav')
        ...
        <div class="block-30 item" style="background-image: url('images/bg_1.jpg');" data-stellar-background-ratio="0.5">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-7">
                        <h2 class="heading">Union africaine de la jeunesse pour la transformation comunautaite</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 pr-lg-5">
                ...
                <h2>Union africaine de la jeunesse pour la transformation comunautaite</h2>
                ...
                <span class="donation-time mb-3">unité et Travail dans la Diversité</span>
