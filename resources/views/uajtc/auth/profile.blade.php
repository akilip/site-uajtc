...
@section('contain')<div class="container-fluid">
            ...
            <div class="card profile-card">
                ...
                <div class="profile-body">
                    <div class="image-area">
                        <form  action="{{route('profile')}}" method="post" enctype="multipart/form-data" id="profilePic">
                            @csrf
                            <input name="image" type="file" id="profilepicture" class="hiddeninput">
                       <style>
                            .hiddeninput{
                                position: absolute;
                                margin-top: 3px;
                        ...
                        <label  for="profilepicture"><img src="{{asset('storage/'.$user->image()->where('actif',true)->first()->avatar_path)}}" alt="UAJTC - Profile Image"></label>
                    </div>
                    <div class="content-area">
                        <h3>{{$user->name}} {{$user->postname}}</h3>
                        <p></p>
                        <p>{{$user->surname}}</p>
                    </div>
                </div>
                                ...
                                <div class="panel panel-default panel-post">
                                    ...
                                    <div class="panel-body">
                                        <div class="post">
                                            ...
                                            <div class="post-content">
                                                <iframe src="https://www.youtube.com/embed/10r9ozshGVE" allowfullscreen="" width="100%" height="360" frameborder="0"></iframe>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel-footer">
